  ...
  const outgoing: ChatMessage[] = [
    ...
    },
    {
      ...
      content: [
        ...
        "When a task should update an existing document, prefer UPDATE blocks instead of rewriting the whole file. Valid forms are: UPDATE[stage][path][replace] with SEARCH...ENDSEARCH and CONTENT...ENDCONTENT blocks, UPDATE[stage][path][insert-after] with ANCHOR...ENDANCHOR and CONTENT...ENDCONTENT blocks, UPDATE[stage][path][insert-before] with ANCHOR...ENDANCHOR and CONTENT...ENDCONTENT blocks, or UPDATE[stage][path][append|prepend] with CONTENT...ENDCONTENT, then ENDUPDATE.",
  ...
  const outgoing: ChatMessage[] = [
    ...
    },
    {
      ...
      content: [
        ...
        "When a task should revise an existing document, prefer UPDATE blocks over whole-file rewrites. Valid forms are UPDATE[stage][path][replace] with SEARCH...ENDSEARCH and CONTENT...ENDCONTENT blocks, UPDATE[stage][path][insert-after] with ANCHOR...ENDANCHOR and CONTENT...ENDCONTENT blocks, UPDATE[stage][path][insert-before] with ANCHOR...ENDANCHOR and CONTENT...ENDCONTENT blocks, or UPDATE[stage][path][append|prepend] with CONTENT...ENDCONTENT, then ENDUPDATE.",
